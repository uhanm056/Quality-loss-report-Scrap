  ...
  mk('cRoll',{data:{labels:sl(LBL),datasets:[
   ...
   options:{responsive:true,maintainAspectRatio:false,
    ...
    plugins:{legend:{display:false},
      datalabels:{display:c=>c.datasetIndex<2&&dlVal(c)!=null&&(rTo-rFrom)<=17,
...
function qYoY(){
  ...
  mk('cYoY',{type:'bar',data:{labels:MO3,datasets:[
   ...
   options:{responsive:true,maintainAspectRatio:false,
    plugins:{legend:{display:false},
      datalabels:{display:c=>dlVal(c)!=null,color:c=>c.dataset.backgroundColor==='#CBD5E1'?'#475569':c.dataset.backgroundColor,
